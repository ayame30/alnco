var TerminalEmulator = {
  ...
  TE.wait(1000, false)
    .then( TE.enterInput.bind(TE, 'list services') )
    .then( TE.enterCommand.bind( TE ) )
    .then( TE.enterResponse.bind(TE, 'Requesting services...') )
    .then( TE.wait.bind(TE, 2000) )
    .then( TE.enterResponse.bind(TE, '- Web apps') )
    .then( TE.enterResponse.bind(TE, '- Mobile apps') )
    .then( TE.enterResponse.bind(TE, '- Web designs') )
    .then( TE.wait.bind(TE, 400) )
    .then( TE.enterResponse.bind(TE, 'New website coming soon...') )
